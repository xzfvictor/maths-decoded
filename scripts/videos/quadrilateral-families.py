...
class QuadrilateralFamiliesScene(Scene):
    def construct(self) -> None:
        ...
        para  = _quad([-5.0, 0.5, 0], 3.0, 1.6, BLUE_TERM)
        rect  = _quad([-2.5, -0.6, 0], 2.4, 1.6, TEAL_TERM)
        rhom  = _quad([ 2.5, -0.6, 0], 2.6, 1.6, ORANGE_TERM)
        sq    = _quad([ 0.0, -1.0, 0], 1.8, 1.8, GREEN_OK)
